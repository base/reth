...
mod tests {
    ...
    use reth_provider::{
        ...
        PruneCheckpointReader, StageCheckpointReader, StateProviderBox, TrieDbTxProvider,
    };
    ...
    where
        F: DatabaseProviderFactory<
                Provider: BlockReader + StageCheckpointReader + PruneCheckpointReader + TrieDbTxProvider,
            > + Clone
            + Send
            + 'static,
    {
