use crate::{
    providers::triedb::triedb_account_to_reth,
    AccountReader, BlockHashReader, ChangeSetReader, HashedPostStateProvider, ProviderError,
    StateProvider, StateRootProvider, TrieDbTxProvider,
};
...
impl<Provider: DBProvider + TrieDbTxProvider + BlockNumReader + ChangeSetReader> AccountReader
...
impl<
        Provider: DBProvider + TrieDbTxProvider + BlockNumReader + BlockHashReader + ChangeSetReader,
...
reth_storage_api::macros::delegate_provider_impls!(HistoricalStateProvider<Provider> where [Provider: DBProvider + TrieDbTxProvider + BlockNumReader + BlockHashReader + ChangeSetReader]);
