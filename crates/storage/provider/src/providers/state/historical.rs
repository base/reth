use crate::{
    ...
    ProviderError, RocksDBProviderFactory, StateProvider, StateRootProvider, TrieDbTxProvider, providers::triedb::triedb_account_to_reth
};
...
reth_storage_api::macros::delegate_provider_impls!(HistoricalStateProvider<Provider> where [Provider: DBProvider + BlockNumReader + BlockHashReader + ChangeSetReader + StorageSettingsCache + RocksDBProviderFactory + TrieDbTxProvider + NodePrimitivesProvider]);
...
mod tests {
    ...
    use crate::{
        ...
        StateProvider, TrieDbTxProvider,
    };
