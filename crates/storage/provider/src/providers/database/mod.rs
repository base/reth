use crate::{
    providers::{
        ...
        StaticFileProvider, StaticFileProviderRWRefMut, TrieDbProvider,
    },
    to_range,
...
mod tests {
    ...
    use reth_db::{
        ...
        test_utils::{create_test_rocksdb_dir, create_test_static_files_dir, create_test_triedb_dir, ERROR_TEMPDIR},
    };
    ...
    fn provider_factory_with_database_path() {
        ...
        let (_, triedb_dir_path) = create_test_triedb_dir();
