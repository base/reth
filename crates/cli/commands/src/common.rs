...
use reth_provider::{
    providers::{
        BlockchainProvider, NodeTypesForProvider, RocksDBProvider, StaticFileProvider, TrieDbProvider,
...
impl<C: ChainSpecParser> EnvironmentArgs<C> {
        ...
        C: ChainSpecParser<ChainSpec = N::ChainSpec>,
    {
        ...
        let triedb_path = data_dir.triedb();
        ...
        info!(target: "reth::cli", ?db_path, ?sf_path, ?triedb_path, "Opening storage");
        ...
        let triedb_provider = TrieDbProvider::open(triedb_path)?;
